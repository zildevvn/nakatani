 ...
 * @return void
 */
add_action('nakatani_hook_header', 'nakatani_header_template');
function nakatani_header_template()
{
 ...
 * @return void
 */
add_action('nakatani_hook_footer', 'nakatani_footer_template');
function nakatani_footer_template()
{
 ...
 * @return void
 */
add_action('nakatani_hook_search', 'nakatani_search_template');
function nakatani_search_template()
{
 ...
 * @return void
 */
add_action('nakatani_hook_post_loop_item', 'nakatani_post_loop_item_template', 20, 2);
function nakatani_post_loop_item_template($post_id, $index)
{
	set_query_var('post_id', $post_id);
?>
	<article <?php post_class('col-md-4') ?>>
		<?php nakatani_post_item() ?>
	</article>
<?php
}
